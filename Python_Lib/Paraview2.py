...
def Export_VTK(filename, Rho_real, Vel_real, T_real, Rho_imag, Vel_imag, T_imag, Coords_list, Dim_arr):
    ...
    Automatically creates the directory structure for 'filename' if it doesn't exist.
    """

    # --- 0. NEW: HANDLE FOLDER CREATION ---
    # Convert string path to Path object
    file_path = Path(filename)
    # Create parent directories (e.g. case_folder/Output/...) if missing
    ...
    # Use file_path (the Path object) instead of the raw string
